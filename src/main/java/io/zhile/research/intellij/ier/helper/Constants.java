...
public class Constants {
    public static final String ACTION_NAME = "Reset Idea Trial";
    public static final String PLUGIN_ID_STR = "fu.meter.idea.ResetTrial";
    ...
    public static final String RESET_ACTION_ID = "fu.meter.idea.ResetTrial";
    public static final String RESTART_ACTION_ID = "fu.meter.idea.RestartAction";
}
